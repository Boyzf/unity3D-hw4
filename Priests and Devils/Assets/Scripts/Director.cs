...
namespace Com.Mygame {
	...
	public class CoastController {
		...
		readonly Vector3 from_pos = new Vector3(8.5f,0.5f,0);
		readonly Vector3 to_pos = new Vector3(-8.5f, 0.5f, 0);
		...
		public CoastController(string _to_or_from) {
			positions = new Vector3[] {new Vector3(6.5F,1.3f,0), new Vector3(7.5F,1.3F,0), new Vector3(8.5F,1.3F,0), 
				new Vector3(9.5F,1.3F,0), new Vector3(10.5F,1.3F,0), new Vector3(11.5F,1.3F,0)};
	...
	public class BoatController {
		...
		public BoatController() {
			...
			from_positions = new Vector3[] { new Vector3 (4.5F, 1.3f, 0), new Vector3 (5.5F, 1.3f, 0) };
			to_positions = new Vector3[] { new Vector3 (-5.5F, 1.3f, 0), new Vector3 (-4.5F, 1.3f, 0) };
